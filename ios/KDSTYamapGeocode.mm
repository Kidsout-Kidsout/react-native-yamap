...
@implementation KDSTYamapGeocode {
...
- (void)geocode:(nonnull NSString *)searchQuery resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
...
- (void)geocodeUri:(nonnull NSString *)uri resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  dispatch_async(dispatch_get_main_queue(), ^{
    @try {
      NSString *key = [[NSUUID UUID] UUIDString];
...
- (void)geocodePoint:(nonnull NSArray *)point resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
